...
#              ordinary use of this verb. With no explicit axis, a secondmate
...
#              already recorded for it. An unspecified --tools carries the
#              prior recorded tool scope forward across a same-harness
