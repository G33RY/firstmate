...
# recognition for that case, and fm_nm_run_is_actively_owned below carries the
# exemptions: a live run whose head mismatch is the pipeline's own doing binds
# without head equality.
#
